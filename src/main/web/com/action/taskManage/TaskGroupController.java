...
@Controller
public class TaskGroupController extends ActionController{
	
	@Autowired
	private TaskGroupService taskGroupService;
	
	@RequestMapping(value = "/home/taskGroupManage.do", method = RequestMethod.GET)
	public ModelAndView getUserTaskGroup(){
		ModelAndView mv = new ModelAndView("task/taskGroup");
	...
	@RequestMapping(value = "/home/taskGroupManage.do", method = RequestMethod.POST)
	public ModelAndView addUserTaskGroup(TaskGroup taskGroup){
		ModelAndView mv = new ModelAndView("redirect:/home/taskGroupManage.do");
		int userId=(Integer)getSeesionValue("CurrentUserId");
