							...
							<c:forEach items="${TaskGroupList}" var="taskGroup">
								<tr>
									...
									<th><a href="#" data-toggle="modal"
										...
										<a  data-toggle="modal"
										data-target="#myModal2" onClick="deleteGroup(${taskGroup.groupId})"><span
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="height: 300px">
					<form role="form" action="<%=basePath%>home/taskManage.do"
						method="Post">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel">Delete task group confirm</h4>
				</div>
				<div class="modal-body">Do you want delete the task group and all the tasks belongs the group?</div>
