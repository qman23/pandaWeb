...
public class Utils {
	...
	public static void putExecuteResult(Task t, Map context, Object result) {
		context.put("Task-" + t.getTaskId(), result);
	}

	public static Object getExecuteResult(Task t, Map context) {
		return context.get("Task-" + t.getTaskId());
	}
