...
CREATE TABLE
    ...
    (
        ...
        CONSTRAINT CC1427794913213 FOREIGN KEY (USER_ID) REFERENCES PANDA."USER" (USER_ID),
...
CREATE TABLE
    ...
    (
        TASK_ID INTEGER NOT NULL ,
        TASK_PARAMETER VARCHAR (3200) NOT NULL
    )
    IN PANDASPACE ;
CREATE TABLE
    PANDA.TASK_LOG
    (
        ...
        USER_ID INTEGER NOT NULL ,
        GROUP_ID INTEGER NOT NULL ,
        TASK_LOG CLOB  (500 M )  NOT NULL  LOGGED  NOT  COMPACT,
...
ALTER TABLE PANDA.TASK_GROUP ALTER COLUMN GROUP_NAME SET DATA TYPE VARCHAR ( 500 ) ALTER COLUMN GROUP_DESCRIPTION SET DATA TYPE VARCHAR ( 500 ) ;
CONNECT RESET;